...
def main()->None:
    ...
    if a.command=='autopilot':
        ...
        print(json.dumps({'findings':result.findings,'proposals':result.proposals,'patched':result.patched,'verification_status':result.verification_status,'readiness':asdict(result.readiness)},indent=2)); return
